...
const file_proto_raft_raft_proto_rawDesc = "" +
	...
	"\x04term\x18\x01 \x01(\x03R\x04term2\xf1\x01\n" +
	"\vRaftService\x12D\n" +
	"\vRequestVote\x12\x18.raft.RequestVoteRequest\x1a\x19.raft.RequestVoteResponse\"\x00\x12J\n" +
	"\rAppendEntries\x12\x1a.raft.AppendEntriesRequest\x1a\x1b.raft.AppendEntriesResponse\"\x00\x12P\n" +
	"\x0fInstallSnapshot\x12\x1c.raft.InstallSnapshotRequest\x1a\x1d.raft.InstallSnapshotResponse\"\x00B<Z:github.com/imPranav14/Distributed-KV-Store/proto/raft;raftb\x06proto3"
